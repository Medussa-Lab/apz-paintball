  ...
  return (
    ...
    >
      <div className="relative group">
        {/* Pulse ring */}
        <div className="absolute inset-0 rounded-full bg-[#25D366] animate-pulse-ring opacity-50" />
        ...
        <a
          ...
          className="relative w-14 h-14 flex items-center justify-center bg-[#25D366] hover:bg-[#20BA5A] text-white rounded-full shadow-lg transition-all duration-200 hover:scale-105"
        >
